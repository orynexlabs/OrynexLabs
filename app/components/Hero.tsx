    ...
    >
      ...
      <div className="container-width pt-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 font-poppins">
            Building the Future of{' '}
            <span className="text-primary-hero font-poppins">Decentralized Work</span>
          </h1>
